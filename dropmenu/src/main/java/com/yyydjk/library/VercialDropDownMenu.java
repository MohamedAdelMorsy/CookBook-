 ...
 */
public class VercialDropDownMenu extends LinearLayout {
    ...
    public VercialDropDownMenu(Context context) {
        super(context, null);
    }

    public VercialDropDownMenu(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public VercialDropDownMenu(Context context, AttributeSet attrs, int defStyleAttr) {
